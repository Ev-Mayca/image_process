...
int main(int argc, char **argv)
{
    ...
    int flag = 0;
    void *retval;
	unsigned int read_cnt = 100000;
	FILE *foriginal;

    //static int cnt = 0;

    fd = UART0_Open(fd, "/dev/ttyHSU1"); //打开串口，返回文件描述符
...
//		i = 0;
//		while(1){
//			sprintf(name_temp,"gps%03d",i++);
//			if((foriginal = fopen(name_temp,"r")) != NULL){
//
//				fclose(foriginal);
//				continue;
//			}else break;
